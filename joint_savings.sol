...
contract JointSavings {
    ...
    // Define a function named **withdraw** that will accept two arguments - uint amount, payable address recipient
    function withdraw(uint amount, payable address recipient) public {
